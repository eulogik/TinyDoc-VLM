...
- [x] **Integrity (2026-09-23):** `INTEGRITY_FAILS: NONE` — schema/engine construct OK, remote PAT-free, ship-file secret scan clean, funsd scores present, `pytest tests/test_pipeline.py` 30/30, demo main `HTTP 200`.
